...
|  |  |
|--|--|
| ![enter image description here](gambar/prototype/landingpage.png) Pada halaman login admin diminta untuk mengisi username dan password.|
| ![enter image description here](gambar/prototype/login.png) Pada halaman ini diminta untuk login.|
| ![enter image description here](gambar/prototype/regis.png) Pada halaman ini disuruh untuk registrasi| ![enter image description here](gambar/prototype/home.png) Pada Halaman ini merupakan tampilan home|
| ![enter image description here](gambar/prototype/absen.png) Pada Halaman ini dusurh untuk mengisi data absen| ![enter image description here](gambar/prototype/feedback.png) Pada halaman ini disuruh untuk mengisi feedback|
| ![enter image description here](gambar/prototype/akun.png) Pada Halaman ini merupakan tampilan halaman akun |
